...
@section('content')
    <section>
        <ol class="breadcrumb">
            ...
            <li class="active">Editovanje Korisnika</li>
        </ol>
        <div class="section-header">
            <h3 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Forma za editovanje Korisnika</h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="box box-outlined">
                        <div class="box-head">
                            <header><h4 class="text-light">Izmeni Korisnika:</h4></header>
                        </div>
                        <div class="box-body no-padding">
                            {!! Form::model($user, array('method' => 'PATCH', 'url' => 'admin/users/'.$user->id, 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'novalidate' => 'novalidate', 'files' => true)) !!}

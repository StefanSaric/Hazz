                            ...
                            <ul>
                                <li class="active"><a href="index.html">Home</a>
                                    <ul>
                                        ...
                                        <li><a href="index7.html">home page seven</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#">womem's</a>
                                    <ul>
                                        ...
                                        <li><a href="shop.html">Electtronic</a></li>
                                    </ul>
                                </li>
...
<!-- header end -->
<div class="breadcrumbs-area bg-4 mb-50">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6" style="margin-left: auto;
                ...
                <div class="account  bg-1  p-20  mb-30" style="">
